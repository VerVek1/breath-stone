...
<div class="container" style="padding:24px 0 48px 0; max-width:720px;">
    <h1 style="margin:0 0 16px 0;">Новый производитель</h1>
    <form method="POST" action="{{ route('admin.manufacturers.store') }}">
        ...
        <div class="mb-3" style="margin-bottom:12px;">
            ...
            <input type="text" name="country" value="{{ old('country') }}" class="form-control" style="width:100%; padding:10px; border-radius:8px; background:#111; border:1px solid #2a2a2a; color:#fff;">
